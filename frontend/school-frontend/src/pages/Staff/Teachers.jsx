...
export default function Teachers() {
  ...
  useEffect(() => {
    fetch("/api/staff/role/teacher")
      .then((res) => {
        if (!res.ok) throw new Error("Failed to fetch teaching staff");
        return res.json();
      })
      .then((data) => {
        setStaff(data);
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      <h1 className="text-3xl font-bold text-blue-700 mb-4">Our Teachers</h1>
      <p className="text-gray-700 mb-8">Meet our dedicated teaching staff.</p>
